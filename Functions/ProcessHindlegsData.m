...
%PROCESSHINDLEGSDATA Proximal-Knee Angle and Distance, Knee-Distal Angle and Distance, Area, + confidence for each, Right and Left
    ...
    Hindlegs_RawData = [Hindlegs_RawData, Hindlegs_Knee_Right_X, Hindlegs_Knee_Right_Y, Hindlegs_Knee_Right_Confidence];
    Hindlegs_RawData = [Hindlegs_RawData, Hindlegs_Distal_Right_X, Hindlegs_Distal_Right_Y, Hindlegs_Distal_Right_Confidence];
    Hindlegs_RawData = [Hindlegs_RawData, Hindlegs_Abdoment_Right_X, Hindlegs_Abdoment_Right_Y, Hindlegs_Abdoment_Right_Confidence];
    Hindlegs_RawData = [Hindlegs_RawData, Hindlegs_Proximal_Left_X, Hindlegs_Proximal_Left_Y, Hindlegs_Proximal_Left_Confidence];
    Hindlegs_RawData = [Hindlegs_RawData, Hindlegs_Knee_Left_X, Hindlegs_Knee_Left_Y, Hindlegs_Knee_Left_Confidence];
    Hindlegs_RawData = [Hindlegs_RawData, Hindlegs_Distal_Left_X, Hindlegs_Distal_Left_Y, Hindlegs_Distal_Left_Confidence];
    Hindlegs_RawData = [Hindlegs_RawData, Hindlegs_Abdoment_Left_X, Hindlegs_Abdoment_Left_Y, Hindlegs_Abdoment_Left_Confidence];
