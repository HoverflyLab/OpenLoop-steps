...
allFiles = {csvFiles.names};
singleVidFiles = regexp(allFiles, videoName);
...
modelList = zeros(1,length(models));
...
for i = 1:length(models)
    tempModelTest = regexp(singleVidFiles, models(i));
